...
export const defaultContent: SiteContent = {
  person: {
    fullName: 'Matsobane Freddy Makgai',
    displayName: 'Our dearest Papa',
    yearsLabel: '1958 — 2024',
    caption: 'Our dearest Papa',
    tagline: 'Forever in our hearts, forever in our memories.',
    homeQuote:
      'A husband, a father, and a pastor — he never failed to deliver the word of God. His voice still echoes in our hearts.',
    portraitSrc: '/images/portrait.png',
    birthDate: '1958-08-08',
    deathDate: '2024-07-09',
    burialDate: '2024-07-14',
  },
  story: {
  ...
  family: {
    ...
    grandchildren: [],
    epigraph: '"Every branch bends toward the sun he planted us in."',
  },
  memories: [
    {
      quote:
  ...
  gallery: [
    { id: 1, title: 'Speaking from the heart', category: 'Tributes', src: '/images/dad1.jpeg' },
    { id: 2, title: 'Standing side by side', category: 'Family', src: '/images/dad2.jpeg' },
    { id: 3, title: 'Portrait of our beloved', category: 'Family', src: '/images/portrait.png' },
    { id: 4, title: 'Family gathered in prayer', category: 'Family', src: '/images/relative1.jpeg' },
    { id: 5, title: 'Together under the tent', category: 'Family', src: '/images/relative2.jpeg' },
    { id: 6, title: 'Words of remembrance', category: 'Tributes', src: '/images/relative3.jpeg' },
    { id: 7, title: 'A loving tribute', category: 'Tributes', src: '/images/relatives3.jpeg' },
    { id: 8, title: 'Songs of farewell', category: 'Tributes', src: '/images/ceb1.jpeg' },
    { id: 9, title: 'Lifting his memory in song', category: 'Tributes', src: '/images/ceb2.jpeg' },
    { id: 10, title: 'Colleagues and friends', category: 'Family', src: '/images/colleques1.jpeg' },
    { id: 11, title: 'At rest', category: 'Service', src: '/images/casket1.jpeg' },
    { id: 12, title: 'Final goodbye', category: 'Service', src: '/images/casket2.jpeg' },
  ],
  videos: [
  ...
  legacy: {
    ...
    resting: {
      eyebrow: 'Resting Place',
      heading: 'Where We Come to Sit With Him',
      epitaph: '"Robala ka kgotso, Hlabirwa."',
      note: 'In loving memory of Matsobane Freddy Makgai · 8 August 1958 – 9 July 2024, laid to rest 14 July 2024. His headstone was raised by the family — a quiet place to bring flowers, sit a while, and say the things we still want to say.',
      verse:
        '"Ke hlabane tlhabano e botse; ke feditše go šiana; tumelo ke e swere." — 2 Timothy 4:7',
      imageSrc: '/images/tombstone.jpg',
      imageAlt: 'The headstone of Matsobane Freddy Makgai at his resting place',
    },
    giftQuote: 'You will not be remembered for what you had, but for who you helped become.',
    giftNote:
      'Every child he raised, every friend he steadied, every grandchild who now says "because Papa said so" — that is his legacy. And it grows a little every day.',
  },
  anniversary: {
    farewell:
      'Though we cannot see you, we feel you in the soft morning light, in the pause between our words, in the small acts of kindness we choose because of you.',
    signOff: '— Rest gently, dear Papa.',
  },
}
